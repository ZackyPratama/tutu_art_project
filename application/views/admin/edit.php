                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" encrype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    <img src="<?= base_url('uploads/') . $gallery[0]['gambar']; ?>"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nama" class="form-control" id="prodi"
                                        placeholder="Nama Photo" value="<?= set_value('nama'); ?>">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="kategori" class="form-control" id="kategori"
                                        placeholder="kategori" value="<?= set_value('kategori'); ?>">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="keterangan" class="form-control" id="keterangan"
                                        placeholder="keterangan" value="<?= set_value('email'); ?>">
